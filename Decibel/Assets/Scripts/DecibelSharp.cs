...
public class DecibelSharp : MonoBehaviour
{
    ...
    private const float THRESHOLD = 0.10f;  // Minimum amplitude to extract pitch (recieve anything)
    ...
    private AudioSource audio;          // The source
    ...
    private void DeriveBlow()
    {
        ...
        {
            Debug.Log("BlowTime: " + blowingTime + "\n" + "Req: " + requiedBlowTime) ;
